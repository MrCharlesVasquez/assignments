...
while(!gameOver){
    ...
    if(userAnswer === 0){
        console.log("tisk, tisk, you lost your hand it is now chopped off and you bled to Death. (Game Over)")
        gameOver = true
    ...
    console.log("The door can not open without a key")
} else if (userAnswer === 2 && key === true){
    console.log("YOU ESCAPED " + name + "!")
        gameOver = true
} else if (userAnswer === 3){
    console.log("You drank poison! You will die rapidly, Game Over")
        gameOver = true
} else if (userAnswer === -1){
